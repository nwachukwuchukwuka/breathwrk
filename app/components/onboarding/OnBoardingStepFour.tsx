...
const OnBoardingStepFour = () => {
    ...
    const fadeValueBrain = useSharedValue(0);
    const verticalPositionFouBrain = useSharedValue(50);
    ...
    useEffect(() => {
        ...
        fadeValueBrain.value = withTiming(1, { duration: 3000 });
        verticalPositionFouBrain.value = withTiming(0, { duration: 1000 });
        setTimeout(() => {
    ...
    return (
        <View className='items-center mt-20'>
            <Animated.View style={slideInBrain} className="items-center mb-10">
