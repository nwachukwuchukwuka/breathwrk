            ...
            <View className='top-56'>
                ...
                >
                    <View className='bg-white/10 rounded-full w-[128px] h-[128px] items-center justify-center'>
                        <Text className='text-white font-bold text-6xl'>59</Text>
                    </View>
                </CircularProgress>
            </View>

            <Animated.Text style={animatedStyle} className="text-white/80 text-md text-center font-bold mt-[220px]">{textStepsContent[9].line2}</Animated.Text>
