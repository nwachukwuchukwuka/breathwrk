...
const GoalPill = ({ goal, index, currentStep }: { currentStep: number }) => {
  ...
  // useEffect(() => {
  //   const delay = goal.secondTop;
  //   const secondLeft = goal.secondLeft;
  //   translateY.value = withDelay(delay, withSpring(delay, springConfig));

  //   translateX.value = withDelay(secondLeft, withSpring(secondLeft, springConfig));
